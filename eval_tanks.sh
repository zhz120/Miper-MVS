...
CKPT_FILE="./checkpoints/dtu/model_000016.ckpt"
# CKPT_FILE="./checkpoints/blendedmvs/model_000015.ckpt"

TANK_TESTING="/home/god/mvs/tankandtemples/"
...
#--testpath=$TANK_TESTING --geo_pixel_thres=1 --geo_depth_thres=0.01 --photo_thres=0.28 \
#--outdir=$OUT_DIR --loadckpt $CKPT_FILE $@
